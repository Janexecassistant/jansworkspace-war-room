...
function CommanderCore({ active, label }: CommanderCoreProps) {
  return (
    <div
      className={`commander-core relative flex h-56 w-56 flex-col items-center justify-center gap-2 rounded-full border border-amber-300/50 bg-gradient-to-b from-[#1a0f1f] via-[#120912] to-[#05030a] text-center shadow-[0_0_90px_rgba(251,191,36,0.35)] ${
    ...
    >
      ...
      <div className="commander-core__monogram">Jan</div>
      <div className="commander-core__version-pill">1.2</div>
      <p className="commander-core__subtitle">Merch on Tap · Command Hub</p>
      <p className="commander-core__state-text">{active ? "Directive live" : "Standby"}</p>
      <p className="commander-core__timestamp-text">{label}</p>
    </div>
  );
}
